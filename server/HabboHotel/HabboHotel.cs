...
namespace Ion.HabboHotel
{
    ...
    public class HabboHotel
    {
        ...
        public HabboHotel()
        {
            ...
            IonEnvironment.Log.WriteLine(string.Format("Initialized project 'Habbo Hotel' for version {0}.", mVersion));
        }
        #endregion
        ...
        public void Destroy()
        {
            ...
            IonEnvironment.Log.WriteLine(string.Format("Destroyed project 'Habbo Hotel' for version {0}.", mVersion));
        }
